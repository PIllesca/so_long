...
/*   Updated: 2024/05/03 17:16:42 by pillesca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player(t_data *data)
{
	...
	mlx_delete_texture(t_down);
	mlx_delete_texture(t_up);
	mlx_delete_texture(t_left);
	mlx_delete_texture(t_right);
